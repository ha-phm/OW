      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 w-full flex-1 flex flex-col">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-12 relative z-10 flex-1 py-8 lg:py-0">
          ...
          <div className="w-full lg:w-1/2 relative flex justify-center items-center mt-10 lg:mt-0">
            ...
            {/* Khối Form Đăng nhập */}
            <div className="relative z-10 w-full max-w-105 bg-white/10 backdrop-blur-xl border border-white/20 rounded-4xl p-6 sm:p-10 shadow-2xl">
              ...
              <div className="mt-6 text-center text-sm text-white/70">
                Chưa có tài khoản?{' '}
                <Link href="/signup" className="text-[#4ade80] hover:text-[#22c55e] hover:underline font-medium transition-colors">
                  Đăng ký ngay
                </Link>
              </div>
            </div>
